...
import com.dinstone.practice.jsa.FileUtil;

/**
 * @author guojf
 * @version 1.0.0.2013-2-19
 */
public class DemoDoPrivilege {

    /**
     * -Djava.security.policy=MyPolicy.txt
     * 
     * @param args
     */
    public static void main(String[] args) {
        ...
        try {
            ...
            File fs = new File("D:\\workspaces\\workspace-xp\\projectX\\bin\\temp2.txt");
            fs.createNewFile();
        } catch (IOException e) {
            e.printStackTrace();
