...
public class Base64 {
    ...
    /**
     * Encodes String(utf-8) into a BASE64 <code>byte[]</code>.
     * 
     * @param s
     * @return
     */
    public static byte[] encode(String s) {
        try {
            return encodeToByte(s.getBytes(DEFAULT_ENCODING), false);
    ...
    public static String encodeToString(String s) {
        try {
            return new String(encodeToByte(s.getBytes(DEFAULT_ENCODING), false));
        } catch (UnsupportedEncodingException unex) {
            return null;
        }
    }
    ...
    public static String encodeToString(byte[] b) {
        return new String(encodeToByte(b, false));
    }

    /***
     * Encodes a raw byte array into a BASE64 <code>byte[]</code>.
     */
    private static byte[] encodeToByte(byte[] arr, boolean lineSep) {
    ...
    public static String decodeToString(String s) {
        try {
            return new String(decode(s), DEFAULT_ENCODING);
        } catch (UnsupportedEncodingException unex) {
            return null;
        }
    }
